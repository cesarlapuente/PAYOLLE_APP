...
public class Util {
    ...
    public static String getUrlRouteBaseLayerOffline(MainApp app, String paramNid, String paramMapUrl) {
		...
		String basemap = demoDataFile + File.separator + app.CARPETA_SD + File.separator + idStr;
    ...
    public static String getUrlGeneralBaseLayerOffline(MainApp app) {
	    ...
	    String siteMapFile = demoDataFile + File.separator + app.CARPETA_SD + File.separator + "LorraineALL.tpk";
