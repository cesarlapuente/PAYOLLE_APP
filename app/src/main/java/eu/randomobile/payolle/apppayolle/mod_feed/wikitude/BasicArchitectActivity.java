package eu.randomobile.payolle.apppayolle.mod_feed.wikitude;
...
import eu.randomobile.payolle.apppayolle.mod_feed.wikitude.location.ILocationProvider;
import eu.randomobile.payolle.apppayolle.mod_feed.wikitude.location.LocationProvider;
...
//		final ArchitectConfig config = new ArchitectConfig( MainApp.WIKITUDE_SDK_KEY );
        final StartupConfiguration config = new StartupConfiguration(MainApp.WIKITUDE_SDK_KEY);
