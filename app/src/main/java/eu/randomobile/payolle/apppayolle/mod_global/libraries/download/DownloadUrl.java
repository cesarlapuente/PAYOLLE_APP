package eu.randomobile.payolle.apppayolle.mod_global.libraries.download;
...
public class DownloadUrl extends AsyncTask<String, Integer, String> {
    ...
    // Obtiene el tama�o global de las imagenes a descargar.
    private int getFilesSizes(String... sUrl) {
    	...
    	for (int i=0; i<sUrl.length; i++) {
    		try {
    			...
    			Log.d("Milog", "Excepcion al calcular tama�o ficheros descarga: " + e.toString());
            }
            if (connection != null)
