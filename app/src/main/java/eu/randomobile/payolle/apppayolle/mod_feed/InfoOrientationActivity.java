...
public class InfoOrientationActivity extends Activity {
    ...
    private MainApp app;
    private ImageButton openInfoLegende;
    private ImageView openInfoMateriel;
    private FrameLayout legendeText;
    private FrameLayout materielText;
    private TextView legendeDescription;
    private TextView legendeTitle;
    private TextView materielTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.feed_activity_info_orientation);
        listInfoAdapter =  new FeedInfoList(this, app.getInfoListCO());
    ...
    private void escucharEventos() {
        ...
        btn_home.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(InfoOrientationActivity.this, HomeActivity.class);
        ...
        btn_return.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        InfoOrientationActivity.this.finish();
                    }
                });
        btn_map.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(InfoOrientationActivity.this, FeedRouteActivity.class);
                        startActivity(intent);
                    }
                });
        btn_list.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(InfoOrientationActivity.this, RoutesListActivity.class);
                        startActivity(intent);
                    }
                });
        btn_badges.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(InfoOrientationActivity.this, BadgesActivity.class);
                        startActivity(intent);
                    }
                });
    }
    public  class FeedInfoList extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            LinearLayout mViewGroup = new LinearLayout(InfoOrientationActivity.this);
